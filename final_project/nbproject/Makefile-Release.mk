...
${OBJECTDIR}/IAStopped.o: IAStopped.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IAStopped.o IAStopped.cpp
...
${OBJECTDIR}/gameover_state.o: gameover_state.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gameover_state.o gameover_state.cpp

${OBJECTDIR}/gamewin_state.o: gamewin_state.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gamewin_state.o gamewin_state.cpp
...
${OBJECTDIR}/intro_state.o: intro_state.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/intro_state.o intro_state.cpp
...
${OBJECTDIR}/transition_state.o: transition_state.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/transition_state.o transition_state.cpp
